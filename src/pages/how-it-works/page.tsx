...
const customerSteps = [
  ...
  { step: 2, icon: 'ri-shield-check-line', title: 'Check Verification', desc: 'Every listing shows a "Verified by Mabidha" or "Inspected" badge. You know exactly what\'s real and what\'s been checked.' },
...
const businessSteps = [
  ...
  { step: 2, icon: 'ri-user-follow-line', title: 'Mabidha Physical Verification', desc: 'Our agents will physically visit your property or business location to verify it matches your listing details.' },
...
const faqs = [
  { q: 'Is Mabidha free for customers?', a: 'Yes! Customers can browse all listings, view details, and contact owners completely for free. No account needed.' },
    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <main className="pt-16">
        ...
        <div className="bg-gradient-to-br from-emerald-700 to-emerald-900 px-4 md:px-6 py-16 text-center">
          ...
          <h1 className="text-white font-bold text-3xl md:text-5xl max-w-2xl mx-auto leading-tight">How Mabidha Works</h1>
          <p className="text-emerald-100 text-sm md:text-base mt-4 max-w-xl mx-auto leading-relaxed">
            Whether you're looking for a home, a service, or a product — Mabidha makes it safe, simple, and scam-free in Kenya.
          </p>
        ...
        <div className="bg-gray-50 border-y border-gray-100">
          <div className="max-w-7xl mx-auto px-4 md:px-6 py-14">
            <div className="text-center mb-10">
              ...
              <p className="text-gray-500 text-sm mt-2">Only verified businesses and landlords can post listings on Mabidha.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
              {businessSteps.map((s) => (
        ...
        <div className="bg-emerald-700 py-14 px-4 text-center">
          ...
          <p className="text-emerald-100 text-sm mb-6 max-w-md mx-auto">Join thousands of Kenyans who trust Mabidha for safe, verified listings every day.</p>
